...
public class Verdura extends Produto implements Imposto {
    private int imposto;

    public Verdura(String nome, String dataFabr, String dataVal, double valorUnidade, int quantidade, int imposto) {
